...
//Function that draws the entire maze, node by node
...
//Function that checks if a column and row are within the maze area
...
//Function that checks which is the next column of a node
...
//Function that checks which is the next row of a node
